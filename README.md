...
Phase 8では、Phase 1〜7の個人用runtimeを直接Internetへ公開せず、匿名利用者向けのread-only Public Demoを別surfaceとして追加します。個人機能・更新操作・AI生成回答を無効化し、質問、法令履歴、条文比較、confirmed関連資料だけを公開します。設計は [`docs/architecture/phase8-public-demo.md`](docs/architecture/phase8-public-demo.md) を参照してください。
