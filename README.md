...
| 8 | Public Demo | **Pre-public Completion Gate passed / 次: Internet公開承認・公開確認** |
...
Phase 8では、Phase 1〜7の個人用runtimeを直接Internetへ公開せず、匿名利用者向けのread-only Public Demoを別surfaceとして追加します。個人機能・更新操作・AI生成回答を無効化し、質問、法令履歴、条文比較、confirmed関連資料だけを公開します。設計は [`docs/architecture/phase8-public-demo.md`](docs/architecture/phase8-public-demo.md) を参照してください。 Pre-public Completion Gateでは匿名E2E、異常入力、live rate limit、DB DML拒否、個人用application state非干渉、200件の全回帰を再確認しました。Internet公開だけは未実施です。検証証跡は [`docs/validation/phase8-prepublic-completion-gate-20260917.json`](docs/validation/phase8-prepublic-completion-gate-20260917.json) を参照してください。
